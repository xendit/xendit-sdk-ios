...
@interface XENAuthenticatedToken : NSObject
@property (nonatomic, copy) NSString * _Null_unspecified tokenID;
@property (nonatomic, copy) NSString * _Null_unspecified status;
@property (nonatomic, copy) NSString * _Nullable authenticationId;
...
@property (nonatomic, copy) NSString * _Nullable cardArtUrl;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (XENError * _Nonnull)ServerError SWIFT_WARN_UNUSED_RESULT;
@end
